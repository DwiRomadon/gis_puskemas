...
public class Maps extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        public void onBackPressed(){
            Intent i = new Intent(Maps.this, HomeUser.class);
            startActivity(i);
            finish();
        }
                    ...
                    new Response.Listener<JSONObject>() {
                        ...
                        public void onResponse(JSONObject response) {
                            ...
                            try {
                                ...
                                Icon icon = iconFactory.fromResource(R.drawable.marker_puskes);
                                markerOptions.icon(icon);

                                for (int i =0; i < jsonArray.length(); i++){
                                    final JSONObject jsonObject = jsonArray.getJSONObject(i);
                                    final ModelPuskesAdmin petShop = new ModelPuskesAdmin();
                                    final String _id = jsonObject.getString("_id");
                                    final String namaPetshop = jsonObject.getString("namaPuskes");
