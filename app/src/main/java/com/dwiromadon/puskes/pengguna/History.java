...
import com.dwiromadon.puskes.adapter.AdapterHistory;
...
//                                    newsList.clear();
    ...
    public void onBackPressed() {
        Intent i = new Intent(History.this, HomeUser.class);
        startActivity(i);
        finish();
    }
    ...
    public void onConnected(Bundle bundle) {
        ...
        if (location == null) {
            ...
            try {
                ...
                jsonObj1.put("macAddress", DataPuskesPengguna.getMacAddr());
