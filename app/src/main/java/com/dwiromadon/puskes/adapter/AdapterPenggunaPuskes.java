package com.dwiromadon.puskes.adapter;
...
public class AdapterPenggunaPuskes extends BaseAdapter {

    private Activity activity;
    private LayoutInflater inflater;
    private List<ModelPuskesAdmin> item;

    public AdapterPenggunaPuskes(Activity activity, List<ModelPuskesAdmin> item) {
