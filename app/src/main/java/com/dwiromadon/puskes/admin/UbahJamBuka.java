...
public class UbahJamBuka extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ubah_jam_buka);
    ...
    public void onBackPressed(){
        Intent i = new Intent(UbahJamBuka.this, DataPuskesmas.class);
        startActivity(i);
        finish();
    }

    public void ubahJamBuka(JSONObject datas, String hari){
        JsonObjectRequest req = new JsonObjectRequest(Request.Method.PUT, BaseURL.updatePetDataPuskes+ _id +"/" +hari, datas,
